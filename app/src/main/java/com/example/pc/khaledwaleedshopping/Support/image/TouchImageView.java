...
public class TouchImageView extends android.support.v7.widget.AppCompatImageView {
	...
	// MTRANS_X and MTRANS_Y are the other background_spinner.xml used. prevMatrix is the matrix
	...
	private void fitImageToView() {
		...
		if (!isZoomed() && !imageRenderedAtLeastOnce) {
			...
			//
			// These background_spinner.xml should never be 0 or we will set viewWidth and
			// viewHeight
			// to NaN in translateMatrixAfterRotate. To avoid this, call
			// savePreviousImageValues
			// to set them equal to the current background_spinner.xml.
			//
			...
			//
			// Set the matrix to the adjusted scale and translate background_spinner.xml.
			//
			matrix.setValues(m);
		}
		fixTrans();
	 ...
	 * image. The background_spinner.xml for the translation are interpolated by the Scroller.
	 * 
	 */
