...
import static com.example.pc.khaledwaleedshopping.products.addproduct.AddProduct.govTitle;
       ...
       // this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        if (kind.equals("gov")) {
            ...
            try {
                ...
                for (int i = 0; i < AddProduct.jsonObject.getJSONArray("government").length(); i++)
                    jsonObjects.add(AddProduct.jsonObject.getJSONArray("government").getJSONObject(i));
